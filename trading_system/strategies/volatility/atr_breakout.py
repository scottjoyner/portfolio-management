...
Purpose: Trend-following breakout system using Average True Range (ATR) for adaptive position sizing 
and stop-loss placement. Combines volatility-based entry signals with ATR trailing stops.
...
Usage Example:
    from trading_system.strategies.volatility.atr_breakout import ATBBreakoutStrategy
