"""
WilliamsPercentRTrendFollowingStrategy - Trend Following

Purpose: Uses Williams %R for trend identification and momentum signals.
...
class WilliamsPercentRTrendFollowingConfig:
    """Configuration for Williams %R Trend Following Strategy."""
...
class WilliamsPercentRTrendFollowingStrategy:
    """
    ...
    def __init__(self, config: Optional[WilliamsPercentRTrendFollowingConfig] = None):
        """
        ...
        """
        self.config = config or WilliamsPercentRTrendFollowingConfig()
    ...
    def metadata(self) -> dict:
        ...
        """
        return {
            'strategy_id': 'williams_percent_r_trend_following',
            'name': 'Williams %R Trend Following',
            'family': 'Trend Following',
            'purpose': 'Oversold/overbought reversal signals using Williams %R indicator for trend following',
            ...
            'explainability_output': '%R position relative to overbought/oversold levels and trend direction',
