"""
ParabolicSARStrategy - Trend Following

Purpose: Uses Parabolic Stop and Reverse (PSAR) for dynamic stop placement and trend following.
...
class ParabolicSARStrategy:
    ...
    def metadata(self) -> dict:
        ...
        return {
            ...
            'purpose': 'Dynamic stop placement using Parabolic Stop and Reverse indicator',
