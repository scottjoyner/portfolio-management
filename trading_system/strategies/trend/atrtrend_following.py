"""
ATRTrendFollowingStrategy - Trend Following

Purpose: Uses Average True Range (ATR) for volatility-adjusted trend following.
...
class ATRTrendFollowingConfig:
    """Configuration for ATR Trend Following Strategy."""
...
class ATRTrendFollowingStrategy:
    ...
    def __init__(self, config: Optional[ATRTrendFollowingConfig] = None):
        """
        ...
        """
        self.config = config or ATRTrendFollowingConfig()
    ...
    def metadata(self) -> dict:
        ...
        """
        return {
            'strategy_id': 'atr_trend_following',
            'name': 'ATR Trend Following',
            'family': 'Trend Following',
            'purpose': 'Volatility-adjusted trend following using ATR expansion',
