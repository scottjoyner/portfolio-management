"""
IchimokuCloudTrendFollowingStrategy - Trend Following

Purpose: Uses Ichimoku Cloud for trend identification and momentum signals.
...
class IchimokuCloudTrendFollowingConfig:
    """Configuration for Ichimoku Cloud Trend Following Strategy."""
...
class IchimokuCloudTrendFollowingStrategy:
    """
    ...
    def __init__(self, config: Optional[IchimokuCloudTrendFollowingConfig] = None):
        """
        ...
        """
        self.config = config or IchimokuCloudTrendFollowingConfig()
    ...
    def metadata(self) -> dict:
        ...
        """
        return {
            'strategy_id': 'ichimoku_cloud_trend_following',
            'name': 'Ichimoku Cloud Trend Following',
            'family': 'Trend Following',
            'purpose': 'TK cross signals with cloud support/resistance filter for trend following',
