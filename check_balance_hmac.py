#!/usr/bin/env python3
"""
Coinbase Balance Check with Correct HMAC Authentication
"""
...
print('='*60)
print('=== COINBASE BALANCE CHECK (Correct Auth) ===')
print('='*60 + '\n')
...
# Decode secret (it's base64 encoded in .env)
import base64
...
headers = {
    ...
    'CB-ACCESS-PASSPHRASE': '',  # Passphrase might not be needed
}

print(f'\nSending to https://api.coinbase.com{endpoint}\n')
